...
var members = {
  ...
  // KKPsi Beta Upsilon
  "Sofia Alemania":       new Member("Sofia Alemania", "Kaitlyn Watkins", "Tia Liu")
  ...
  "Gus Billing":          new Member("Gus Billing", brother, "Cheyenne Suzukawa", "Sara Acosta"),
  ...
  "Randy Reza":           new Member("Randy Reza", brother, "James Eichenbaum", "Garrett Henkle"),
  "Alexis Toledo":        new Member("Alexis Toledo", brother, "Marcus Veal", "Ethan Cai"),
  "Liam Wallace":         new Member("Liam Wallace", brother, "Leo Pfeiffer", "Brandon Free"),
  ...
  "Adam Traut":           new Member("Adam Traut", brother, "Jazmin Aguila", "Randy Reza"),
